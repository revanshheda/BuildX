...
const dashboardActions = [
  { label: 'Respond to Process Flow query', meta: 'FSSAI · Action required', tone: 'warning', route: '/query/hero-query-01' },
  { label: 'Inspection scheduled', meta: '05 Sep 2026 · 11:00 AM', tone: 'navy', route: '/dashboard' },
  { label: 'FSSAI application', meta: 'Under departmental review', tone: 'success', route: '/application/hero-fssai-01' },
];
...
const features = [
  ...
  },
  {
    ...
    visual: 'validation',
    route: '/application/hero-fssai-01',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
function DashboardVisual({ onNavigate }) {
  return (
...
function FeaturePreview({ visual, onNavigate }) {
  if (visual === 'dashboard') return <DashboardVisual onNavigate={onNavigate} />;
          ...
          <div className="feat-panel" key={activeFeature}>
            <div className="feat-panel-card">
              ...
              <div className="feat-panel-body">
                <FeaturePreview visual={active.visual} onNavigate={handleNavigate} />
              </div>
            </div>
          </div>
        </div>
